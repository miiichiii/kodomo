...
## 進捗（2026-02-24 夜）
- [x] FD TextのPDFを `assets/source/fdata_r2t6_new.pdf` として保存
- [x] PDF内画像を `assets/images/fdtext/` に抽出（`pdfimages -png`）
- [x] クイズUIを画像対応化（問題文の下に画像表示領域を追加）
- [x] 「🖼️ 実践編（画像問題）」モードを追加（6問）
- [ ] 抽出画像の内容を1枚ずつ人手チェックして、問題文との対応精度をさらに上げる